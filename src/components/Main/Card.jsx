        ...
        <>
            <div className="item">
                <div className="item__img-wrap">
                    ...
                    <div className="item__class left">{props.catalog.hz_index}</div>
                    <div className="item__class">{props.catalog.hz_class}</div>
                </div>
                <div className="item__container">
                    ...
                    <div className="item__text">{props.catalog.hz_building_price} за м²/год</div>
                </div >
            </div>
    </>
    )
